...
def get_refiner(config, retriever=None, generator=None):
    ...
    # KG-TRACE refiner (e.g. kg_trace_refiner in step7) has no HuggingFace checkpoint; do not call AutoConfig(None).
    if "kg" in refiner_name.lower() and "trace" in refiner_name.lower():
