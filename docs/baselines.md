...
> 全部分使用对齐的生成参数: `max_new_tokens=384, temperature=1.0, top_p=1.0, do_sample=True`
...
| 数据集 | Zero-shot | Naive RAG | Elite SFT | ReaRAG | pure_EM | PPO R3 | **PPO R6-A** | **R7-B (step2k)** | **R7-B (final)** | SFT |
|---|---|---|---|---|---|---|---|---|
| hotpotqa | 0.203 | 0.177 | 0.353 | 0.273 | 0.280 | 0.373 | **0.383** | **0.250** | **0.323** | 0.397 |
| 2wiki | 0.080 | 0.007 | 0.273 | 0.027 | 0.247 | 0.213 | **0.257** | **0.037** | **0.233** | 0.303 |
| musique | 0.027 | 0.000 | 0.143 | 0.010 | 0.013 | 0.113 | **0.097** | **0.007** | **0.040** | 0.173 |
| **平均** | **0.103** | **0.061** | **0.257** | **0.103** | **0.180** | **0.233** | **0.246** | **0.098** | **0.199** | **0.291** |

## 三、F1 对比

| 数据集 | Zero-shot | Naive RAG | Elite SFT | ReaRAG | pure_EM | PPO R3 | **PPO R6-A** | **R7-B (step2k)** | **R7-B (final)** | SFT |
|---|---|---|---|---|---|---|---|---|
| hotpotqa | 0.281 | 0.257 | 0.456 | 0.332 | 0.368 | 0.477 | **0.478** | **0.307** | **0.407** | 0.511 |
| 2wiki | 0.225 | 0.105 | 0.315 | 0.033 | 0.271 | 0.257 | **0.272** | **0.044** | **0.243** | 0.334 |
| musique | 0.103 | 0.021 | 0.196 | 0.020 | 0.053 | 0.169 | **0.164** | **0.016** | **0.056** | 0.244 |
| **平均** | **0.203** | **0.127** | **0.322** | **0.128** | **0.230** | **0.301** | **0.305** | **0.122** | **0.235** | **0.363** |
