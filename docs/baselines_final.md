...
## 七、Temperature=0 评估（确定性推理）

> 评估协议同标准 baseline，但 `temperature=0.0, do_sample=False`，每数据集 1 seed。

### 7.1 EM 对比 (t=0)

| 数据集 | CoRAG | R1-Searcher | Elite SFT | Full SFT |
|---|---|---|---|---|
| hotpotqa | 0.27 | 0.30 | 0.39 | 0.43 |
| 2wikimultihopqa | 0.29 | 0.15 | 0.24 | 0.21 |
| musique | 0.02 | 0.01 | 0.12 | 0.11 |
| **平均** | **0.193** | **0.153** | **0.250** | **0.250** |

### 7.2 t=0 vs t=0.7 对比

| Baseline | t=0 | t=0.7 | Δ |
|---|---|---|---|
| CoRAG | 0.193 | 0.167 | +0.026 |
| R1-Searcher | 0.153 | 0.154 | -0.001 |
| Elite SFT | 0.250 | 0.257 | -0.007 |
| Full SFT | 0.250 | 0.291 | -0.041 |

t=0 对 CoRAG 有提升（2wiki 0.13→0.29），对其他模型影响轻微。
