...
export KGPW_TB_DIR=/root/tf-logs/PROOFKG-2WIKI-HARD-V1-PPO-K-V2.1-1200-SEED42

CONFIG=configs/training/phase3_ppo_2wiki_hard_curriculum_v1_process_v2_1_1200_seed42.yaml
LOCK=${CONFIG}.lock.v2.json
OUT=outputs/ppo_2wiki_hard_curriculum_v1_process_v2_1_1200_seed42
LOG=logs/training/ppo_2wiki_hard_curriculum_v1_process_v2_1_1200_seed42.log
PREFLIGHT=logs/training/ppo_2wiki_hard_curriculum_v1_process_v2_1_1200_seed42.preflight.json
